...
| ionization_N+_N2+.dat | e + N+ -> N2+ + 2e | Bell, Gilbody, Hughes, Kingston & Smith, JPCRD 12, 891 (1983), Eq. (1), Table 5 N II (I = 29.60 eV, A = 1.0755, B = −0.8287, 0.8724, −0.1618, 1.5331; ±10 %), read from the page image of the NIST-hosted reprint. Based on Harrison et al. crossed-beam data; the metastable content of that beam is not flagged by Bell (verify if it matters). Formula check: Eq. (1) with Bell's N I row matches NIST Kim & Desclaux (30 % ²D mix) to 1–5 % from 30 eV to 1 keV. Header 29.60125 eV (IE(N II), NIST ASD). `scripts/build_n_plus_ionization_table.py` | present (2026-09-26), verified to 255 eV |
| dissociative_ionization_N2_N2+.dat | e + N2 -> N2+ + N + 3e | Song et al. JPCRD 2023 Table 10 σ(N⁺⁺) (total N⁺⁺ yield from N₂, 70–1000 eV; the extra N⁺ from triple events is not added), linear ramp from σ = 0 at E_th = D₀ + IE(N I) + IE(N II) = 53.885 eV. Header 53.885 eV. `scripts/build_n2_to_n2plus_table.py` | present (2026-09-26), verified to 255 eV |
